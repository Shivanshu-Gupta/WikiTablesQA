...
sealed trait Template {
  ...
  /** Update state by applying this template to expand the  
    * current hole.
    */
  def apply(state: SemanticParserState, parentInput: Expression = null, parentState: Int = 0): SemanticParserState
...
case class ApplicationTemplate(val root: Type, val expr: Expression2,
  ...
  override def apply(state: SemanticParserState, parentInput: Expression = null, parentState: Int = 0): SemanticParserState = {
