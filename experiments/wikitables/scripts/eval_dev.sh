...
SCORES_OUT=$MY_DIR/tokenScores.tsv$EXT
...
$TEST_BEAM_SIZE --maxDerivations $MAX_TEST_DERIVATIONS --tsvOutput $TSV_OUT --scoresOutput $SCORES_OUT --derivationsPath $DERIVATIONS_PATH &> $DEV_LOG
